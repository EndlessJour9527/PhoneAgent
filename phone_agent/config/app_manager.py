...
class AppConfigManager:
    ...
    def _guess_category(self, package_name: str) -> str:
        ...
        if any(x in package_lower for x in ['wechat', 'qq', 'whatsapp', 'telegram', 'mm', 'slack', 'discord']):
            return "社交"
            ...
            return "拍照"
        elif any(x in package_lower for x in ['note', 'calculator', 'calendar', 'clock', 'weather', 'compass', 'scanner']):
            return "工具"
        else:
            return "其他"
